            ...
            {!products || products.length === 0 ? (
              ...
              products.map((product) => (
                <tr key={product.id} className="hover:bg-[#1f242b]/50 transition-colors">
                  ...
                  <td className="p-4">
                    <span className={`px-2.5 py-1 rounded-full text-xs font-medium border whitespace-nowrap ${product.stock > 0 ? 'bg-[#2ea043]/10 text-[#3fb950] border-[#2ea043]/20' : 'bg-[#e5534b]/10 text-[#ff7b72] border-[#e5534b]/20'}`}>
